local iconTypes = {
	...
	cromwell = {
        bitmap   = "icons/Cromwell_IV.tga",
        size     = 2.25,
        distance = 0.3,
    },
	churchill = {
        bitmap   = "icons/Churchill_VII.tga",
        size     = 3,
        distance = 0.4,
    },
	cromwellcs = {
        bitmap   = "icons/Cromwell_VI.tga",
        size     = 2.25,
        distance = 0.3,
    },
	shermanvc = {
        bitmap   = "icons/Sherman_VC.tga",
        size     = 2.75,
        distance = 0.3,
    },
	achilles = {
        bitmap   = "icons/Achilles.tga",
        size     = 2.5,
        distance = 0.3,
    },
	sexton = {
        bitmap   = "icons/Sexton.tga",
        size     = 2.25,
        distance = 0.3,
    },
	aecmkii = {
        bitmap   = "icons/AEC_Mk_II.tga",
        size     = 1.75,
        distance = 0.2,
    },
	daimler = {
        bitmap   = "icons/Daimler.tga",
        size     = 1.75,
        distance = 0.2,
    },
	staghound = {
        bitmap   = "icons/Staghound.tga",
        size     = 1.75,
        distance = 0.2,
    },
	bren = {
        bitmap   = "icons/Bren.tga",
        size     = 2.5,
        distance = 0.15,
    },
	sten = {
        bitmap   = "icons/Sten.tga",
        size     = 1.5,
        distance = 0.15,
    },
	vickers = {
        bitmap   = "icons/Vickers.tga",
        size     = 2,
        distance = 0.15,
    },
}
